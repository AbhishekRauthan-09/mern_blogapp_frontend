...
const CreatePost = () => {
  ...
  const validatInput = () => {
    if (title.length < 120 || title.length > 150) {
      toast.error("Title length: max 150 & min 120", toastOptions);
    } else if (summary.length < 250 || summary.length > 400) {
      toast.error("Summary length: max 400 & min 250", toastOptions);
    } else if (!files[0]) {
      ...
      <div className="section1">
        ...
        <form>
          <textarea
            ...
            placeholder="Title of Blog : min 120 words and max 150 words required"
          ...
          <textarea
            ...
            placeholder="Summary : min 250 words and max 450 words required"
            rows="6"
            cols="50"
